...
description: "Access and manage device contacts with Shiny.Maui.ContactStore, including permissions, CRUD operations, LINQ queries, and paging. Use when Codex implements contact lookup, import, creation, update, or deletion in a .NET MAUI app."
---
