---
name: shiny-push
description: "Implement mobile push notifications with Shiny.Push using native APNs and FCM or Azure Notification Hubs, including permissions, tokens, registration, tags, delegates, and notification handling. Use when Codex changes client-side remote push behavior in .NET MAUI."
---
