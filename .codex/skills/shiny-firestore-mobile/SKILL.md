...
description: "Use Shiny.DocumentDb.Firestore.Mobile for native on-device Firestore on iOS and Android, including offline persistence, real-time listeners, LINQ queries, emulators, and managed Firebase Auth identity. Use when Codex builds a MAUI mobile Firestore store or authentication flow."
---
