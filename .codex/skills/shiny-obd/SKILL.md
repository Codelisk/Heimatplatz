---
name: shiny-obd
description: "Communicate with OBD-II vehicle adapters using Shiny.Obd, including command objects, ELM327 and OBDLink detection, BLE transport, custom PIDs, parsing, and connection management. Use when Codex builds vehicle diagnostics or telemetry features."
---
