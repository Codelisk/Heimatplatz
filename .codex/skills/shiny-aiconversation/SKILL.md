...
description: "Build conversational AI features with Shiny.AiConversation for .NET MAUI, including AI services, chat client providers, persistent history, wake words, voice selection, speech input and output, acknowledgements, and chat lookup tools. Use when Codex works on Shiny voice or chat assistant flows."
---
