---
name: shiny-mediator
description: "Implement Shiny.Mediator CQRS workflows with requests, commands, events, streams, handlers, middleware, generated HTTP clients, OpenAPI, SSE, AI tools, and scaffolding. Use when Codex works on mediator contracts, pipelines, client generation, or ASP.NET Core endpoints."
---
