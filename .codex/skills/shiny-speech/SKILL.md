---
name: shiny-speech
description: "Implement speech-to-text, text-to-speech, audio capture, and playback with Shiny.Speech and its pluggable providers. Use when Codex works on transcription, dictation, synthesis, microphone capture, voice selection, audio sessions, or speech service registration."
---
