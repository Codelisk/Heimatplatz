---
name: shiny-health
description: "Read, write, and observe health data with Shiny Health across Apple HealthKit and Android Health Connect. Use when Codex implements permissions, queries, updates, or live observation for steps, heart rate, sleep, workouts, nutrition, vitals, or other health metrics."
---
