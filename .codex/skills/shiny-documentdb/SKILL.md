...
description: "Use Shiny.DocumentDb providers and APIs for document storage, CRUD and LINQ queries, spatial queries, indexes, migrations, encryption, backup, patching, AOT, and AI tools. Use when Codex works with IDocumentStore or SQLite, LiteDB, CosmosDB, Firestore, SQL, DynamoDB, MongoDB, Redis, or IndexedDB providers."
---
