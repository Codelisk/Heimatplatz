---
name: funktionstest
description: "Fuehre vollstaendige manuelle Funktionstests der Heimatplatz-App fuer Astro-Web in src/web und/oder .NET MAUI in src/maui durch: Funktionsinventar aus dem Code erheben, die laufende App wie ein akribischer menschlicher Tester bedienen, Bugs sowie UI/UX-Auffaelligkeiten reproduzieren und einen Markdown-Bericht erstellen. Use when Codex is asked for a Funktionstest, functional test, QA run, Testdurchlauf, Regressionstest, to test the app, go through every feature, or find bugs."
---
