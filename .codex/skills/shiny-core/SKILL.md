---
name: shiny-core
description: "Configure Shiny core infrastructure for .NET MAUI and native apps, including hosting, dependency injection, key-value stores, startup and lifecycle tasks, permissions, and platform abstractions. Use when Codex works with Shiny.Core, Shiny.Hosting, IPlatform, IKeyValueStore, or lifecycle hooks."
---
