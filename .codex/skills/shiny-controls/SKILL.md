---
name: shiny-controls
description: "Build UI with Shiny.Maui.Controls or Shiny.Blazor.Controls, including tables, trees, panels, camera and media, pickers, editors, overlays, feedback, barcodes, markdown, schedulers, docking, and kiosk controls. Use when Codex creates or changes Shiny control XAML, Razor UI, registration, or platform setup."
---
