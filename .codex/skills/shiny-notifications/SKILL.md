...
description: "Create and manage local notifications with Shiny.Notifications for .NET MAUI, including permissions, channels, schedules, repeating or geofence triggers, badges, sounds, actions, and delegates. Use when Codex implements on-device notification behavior."
---
