...
description: "Implement reliable offline-first bidirectional JSON synchronization with Shiny.Data.Sync, including outbox and inbox processing, background scheduling, deltas, conflicts, delegates, and sync entities. Use when Codex builds mobile or cross-platform data synchronization workflows."
---
