...
description: "Build server-side push delivery with Shiny.Extensions.Push, including APNs, FCM, Web Push, WNS, targeting, topics, interceptors, persistence, dead-token cleanup, multi-app registration, metrics, and tracing. Use when Codex implements or configures push dispatch on an ASP.NET Core backend."
---
