...
description: "Implement GPS tracking, geofencing, and motion activity recognition with Shiny.Locations for .NET MAUI, iOS, and Android. Use when Codex works on foreground or background location readings, geofence monitoring, delegates, permissions, or tracking configuration."
---
