...
description: "Implement Bluetooth LE client and central workflows with Shiny, including scanning, managed scans, connections, GATT services and characteristics, reads, writes, notifications, and permissions. Use when Codex works with IBleManager, IPeripheral, or Shiny.BluetoothLE."
---
