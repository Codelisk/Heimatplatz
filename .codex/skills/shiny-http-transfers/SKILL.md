...
description: "Implement background uploads and downloads with Shiny HTTP Transfers across mobile, desktop, Linux, macOS, and Blazor, including progress, monitoring, constraints, Azure Blob, S3, and service-worker synchronization. Use when Codex builds resilient file transfer workflows."
---
