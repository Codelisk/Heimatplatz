...
description: "Configure modular ASP.NET Core hosting with Shiny.Extensions.WebHosting and IWebModule for service registration and middleware composition. Use when Codex organizes web infrastructure modules, startup registration, or the application request pipeline."
---
