...
using Contracts = Heimatplatz.Features.AppUpdate.Contracts;
...
namespace Heimatplatz.Maui.Features.AppUpdate.Services;

/// <summary>
/// Android implementation of <see cref="Contracts.IAppUpdateService"/> using Google Play Core.
/// Implementiert IAndroidLifecycle.IOnActivityResult, damit Shiny das Update-Flow-Ergebnis
/// automatisch zustellt (kein Code in der MainActivity noetig).
/// </summary>
internal sealed class AndroidAppUpdateService : Contracts.IAppUpdateService, IAndroidLifecycle.IOnActivityResult, IDisposable
{
    ...
    public AndroidAppUpdateService(ILogger<AndroidAppUpdateService> logger)
    {
        ...
        _appUpdateManager = AppUpdateManagerFactory.Create(global::Android.App.Application.Context);
    ...
    /// <summary>
    /// Shiny Android-Lifecycle-Hook: Ergebnis des Update-Flows
    /// (wird von Shiny.Hosting.Maui automatisch aus OnActivityResult zugestellt)
    /// </summary>
...
/// </summary>
internal static class PlayCoreTaskExtensions
{
