...
{
    /// <summary>Inhalt wurde ueber den nativen Share-Dialog geteilt</summary>
    SharedNatively,

    /// <summary>Nativer Share war nicht verfuegbar, Inhalt wurde in die Zwischenablage kopiert</summary>
    CopiedToClipboard,

    /// <summary>Share ist fehlgeschlagen</summary>
    Failed
}

/// <summary>
/// Service fuer Share-Operationen (nativer Share-Dialog)
/// </summary>
