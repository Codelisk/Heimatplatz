...
export const home = {
  ...
  "search.settingsNewBuildTitle": "Neubauprojekte",
  "search.settingsNewBuildHint": "Häuser, die erst geplant oder noch in Bau sind.",
  "search.settingsNewBuildLabel": "Neubauprojekte anzeigen",
