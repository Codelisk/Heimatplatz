...
using Heimatplatz.Api.Features.Feedback.Configuration;
...
using Heimatplatz.Api.Features.Feedback;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApiServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddOpenImmoImportFeature(configuration);
    ...
    public static WebApplication MapEndpoints(this WebApplication app)
    {
        ...
        Heimatplatz.Api.Features.Feedback.MediatorEndpoints.MapGeneratedMediatorEndpoints(app);
        ...
        Heimatplatz.Api.Features.OpenImmoImport.MediatorEndpoints.MapGeneratedMediatorEndpoints(app);
