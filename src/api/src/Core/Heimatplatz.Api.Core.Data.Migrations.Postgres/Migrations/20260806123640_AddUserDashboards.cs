        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerationError = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    GenerationRequestedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    GenerationCompletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPrompt = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    DefinitionJson = table.Column<string>(type: "TEXT", nullable: true),
