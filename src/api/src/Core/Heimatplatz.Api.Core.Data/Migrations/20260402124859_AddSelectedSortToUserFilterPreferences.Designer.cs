...
namespace Heimatplatz.Api.Core.Data.Migrations
{
    ...
    [Migration("20260402124859_AddSelectedSortToUserFilterPreferences")]
    partial class AddSelectedSortToUserFilterPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Heimatplatz.Api.Features.SrealListings.Data.Entities.SrealListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("FGee")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");

                    b.Property<string>("FGeeClass")
                        .HasMaxLength(5)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("SrealListings", (string)null);
                });

            modelBuilder.Entity("Heimatplatz.Api.Features.SrealListings.Data.Entities.SrealListingChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("SrealListingId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("SrealListingId");

                    b.ToTable("SrealListingChanges", (string)null);
                });
            ...
            modelBuilder.Entity("Heimatplatz.Api.Features.SrealListings.Data.Entities.SrealListingChange", b =>
                {
                    b.HasOne("Heimatplatz.Api.Features.SrealListings.Data.Entities.SrealListing", "SrealListing")
                        .WithMany("Changes")
                        .HasForeignKey("SrealListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SrealListing");
                });
